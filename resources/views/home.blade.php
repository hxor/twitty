                            ...
                            <ul>
                                ...
                                <div class="drop-wrap">
                                    <div class="drop-inner">
                                        <ul>
                                            <li><a href="{{ route('profile.user', Auth::user()->username) }}">{{Auth::user()->username}}</a></li>
                                    ...
                                    <div class="info-inner">
                                        ...
                                        <div class="info-in-body">
                                            ...
                                            <div class="info-body-name">
                                                <div class="in-b-name">
                                                    <div><a href="{{ route('profile.user', Auth::user()->username) }}">{{ Auth::user()->name }}</a></div>
                                                    <span><small><a href="{{ route('profile.user', Auth::user()->username) }}">{{ '@'.Auth::user()->username }}</a></small></span>
                                                </div><!-- in b name end-->
                                        ...
                                        <div class="info-in-footer">
                                            <div class="number-wrapper">
                                                ...
                                                <div class="num-box">
                                                    ...
                                                    <div class="num-body">
                                                        <span class="count-following">{{ Auth::user()->following ?? 0 }}</span>
                                                    </div>
                                                </div>
                                                <div class="num-box">
                                                    <div class="num-head">
                                                    ...
                                                    <div class="num-body">
                                                        <span class="count-followers">{{ Auth::user()->followers ?? 0 }}</span>
                                                    </div>
                                                </div>	
                                            </div><!-- mumber wrapper-->
                                        </div><!-- info in footer -->
                        ...
                        <div class="in-center">
                            <div class="in-center-wrap">
                                ...
                                <div class="loading-div">
                                    <img id="loader" src="{{ url('assets/images/loading.svg') }}" style="display: none;"/> 
                                </div>
